...
def generateReadme():
    ...
    with open('README.md', 'w') as handle:
        ...
        handle.write('[![Python Pull Request Workflow](https://github.com/c-wilkinson/StravaDataAnalysis/actions/workflows/workflow-pr.yaml/badge.svg)](https://github.com/c-wilkinson/StravaDataAnalysis/actions/workflows/workflow-pr.yaml)\n\n')
